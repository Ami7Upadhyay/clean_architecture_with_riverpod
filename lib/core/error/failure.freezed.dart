...
class _$_Server implements _Server {
  _$_Server({required this.code, required this.message});
...
abstract class _Server implements Failure {
  factory _Server({required final int code, required final String message}) =
      _$_Server;
...
class _$_Network implements _Network {
  _$_Network({required this.message});
...
abstract class _Network implements Failure {
  factory _Network({required final String message}) = _$_Network;
...
class _$_Exception implements _Exception {
  _$_Exception({required this.message});
...
abstract class _Exception implements Failure {
  factory _Exception({required final String message}) = _$_Exception;
